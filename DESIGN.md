...
> Draft 23 · 25 September 2026 · Status: **for review** · Changes from draft 22: the landing of a revert's refetch is a commit and is announced, so peers that were refused during the window ask again; the restoring flag belongs to the path until a refetch lands (§8.3).
>
