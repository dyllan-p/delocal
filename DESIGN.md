...
> Draft 22 · 25 September 2026 · Status: **for review** · Changes from draft 21: a want keeps the entry as received and is re-classified from it whenever the record at its path is written (§7.5); revert re-derives the wants at every reverted path (§8.3).
>
