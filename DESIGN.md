...
> Draft 18 · 23 September 2026 · Status: **for review** · Changes from draft 17: the fast path compares a symlink's target (§7.3); a reverted path whose content no machine can serve resolves to a tombstone once every member has answered (§8.3).
>
